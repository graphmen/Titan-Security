...
export const FALLBACK_MANIFEST = {
  ...
  monitor: {
    ...
    notes: 'Shows patrol points from saved GPS places. Uses your assigned site only — not the first premises in the list.',
  },
  supervisor: {
    appId: 'supervisor',
    ...
    notes: 'Instant site/place save after GPS capture. GPS cluster averaging for sharper map pins (±5m).',
  },
};
